...
//            holder.size.setText("Size: " + tModels.get(position).getSize());
//            holder.size.setVisibility(View.VISIBLE);
//        } else {
//            holder.size.setVisibility(View.GONE);
//        }
//        if (!tModels.get(position).getProductColor().equalsIgnoreCase("")) {
//            Log.d("color", tModels.get(position).getProductColor());
//            holder.color.setText("Color: " + tModels.get(position).getProductColor());
